...
| 有資料 | 空狀態 |
|---|---|
| ![列表畫面](docs/mockups/mockup01_page-item-list.png) | ![空狀態](docs/mockups/mockup02_page-empty-list.png) |

### 7.2 排序 / 刪除互動

| 排序選單 | 刪除確認 |
|---|---|
| ![排序](docs/mockups/mockup03_sort-bottom-sheet.png) | ![刪除](docs/mockups/mockup04_delete-dialog.png) |

### 7.3 新增 / 編輯畫面

| 新增訂閱 | 編輯訂閱 |
|---|---|
| ![新增](docs/mockups/mockup05_page-add-new.png) | ![編輯](docs/mockups/mockup06_page-edit-item.png) |
