...
val SubscriptionColorScheme = lightColorScheme(
    ...
    onPrimary = ThemeColor.Parchment,
    primaryContainer = ThemeColor.AccentGreenBg,
    onPrimaryContainer = ThemeColor.InkDeep,
    secondary = ThemeColor.InkMid,
    onSecondary = ThemeColor.Parchment,
    secondaryContainer = ThemeColor.CreamDark,
    onSecondaryContainer = ThemeColor.InkDeep,
    tertiary = ThemeColor.InkLight,
    onTertiary = ThemeColor.Parchment,
    tertiaryContainer = ThemeColor.Cream,
    onTertiaryContainer = ThemeColor.InkDeep,
    error = ThemeColor.Danger,
    onError = ThemeColor.Parchment,
    errorContainer = Color(0xFFF5DCD9),
    onErrorContainer = Color(0xFF5C1A18),
    background = ThemeColor.Cream,
    onBackground = ThemeColor.InkDeep,
    surface = ThemeColor.Parchment,
    onSurface = ThemeColor.InkDeep,
    surfaceVariant = ThemeColor.CreamDark,
    onSurfaceVariant = ThemeColor.InkMid,
    outline = ThemeColor.BorderSubtle,
    outlineVariant = ThemeColor.BorderMid,
    scrim = ThemeColor.InkDeep,
    inverseSurface = ThemeColor.InkDeep,
    inverseOnSurface = ThemeColor.Parchment,
    inversePrimary = ThemeColor.AccentGreenLight,
)
